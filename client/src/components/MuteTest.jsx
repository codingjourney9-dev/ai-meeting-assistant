    ...
    try {
      ...
      try {
        ...
        try {
          ...
          setStatus('❌ No microphone found. Please connect a headset or mic.')
          return
        }
      }
      ...
      <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <button
          ...
          style={{
            ...
            padding: '12px 20px', cursor: hasAudio ? 'pointer' : 'not-allowed',
        ...
        <button
          ...
          style={{
            ...
            color: 'white', border: 'none', borderRadius: '8px',
            padding: '12px 20px', cursor: hasVideo ? 'pointer' : 'not-allowed',
